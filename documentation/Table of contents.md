...
- 20.1.1 Sentry: error capture, source maps, releases, breadcrumbs
- 20.1.2 Structured logs and request correlation IDs
- 20.1.3 What to log: the 3am rule and the PII exclusion
- 20.1.4 Vercel Drains: shipping logs to a queryable destination
- 20.1.5 Debugging server-side Next.js with the inspector
- 20.1.6 Chapter quiz
