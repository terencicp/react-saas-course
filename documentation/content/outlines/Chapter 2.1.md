...
- Immutability as the React-shaped reflex, named once. The course's React chapters (Unit 4.7.4, 4.8.2) treat state as immutable; the senior reflex is to copy-then-modify, not to mutate. This lesson plants that reflex at the language level so React doesn't have to re-derive it.
