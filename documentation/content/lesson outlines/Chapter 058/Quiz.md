...
questions:
  ...
  - source: 58.5
    question: |
      Alice invited Bob to Acme, then left the company before Bob accepted. Bob clicks the link the next day. Select every statement that reflects the chapter's senior posture.
    choices:
      - text: |
