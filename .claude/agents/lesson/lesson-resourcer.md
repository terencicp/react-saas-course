...
4 Add them add the end of the lesson in an h2 section "External resources" using ExternalResource: `documentation/components/ui/external-resource.md`. Use a 2 column grid if more than one resource.
