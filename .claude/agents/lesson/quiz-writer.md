...
Write the selected questions to `documentation/content/lesson outlines/<X> <Chapter name>/<Y> Quiz.md` as a YAML document another agent will translate into MDX. Follow this schema:
