...
Read the quiz outline at `documentation/content/lesson outlines/Chapter <X>/Quiz.md` and the quiz component docs under `documentation/components/quiz/quiz.md`.
