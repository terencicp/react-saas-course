...
// Strip the leading `<number> ` prefix folders use for ordering so the
// sidebar shows "Demos" rather than "0 Demos".
const stripOrderPrefix = (name) => name.replace(/^\d+(\.\d+)*\s+/, '');
