...
<VideoCallout videoId="nZrAgov_-D8" videoTitle="Environments on Vercel">
  Vercel's own 11-minute walkthrough of development, preview, and production environments. It shows the same dashboard panel and per-environment values this section describes.
</VideoCallout>
