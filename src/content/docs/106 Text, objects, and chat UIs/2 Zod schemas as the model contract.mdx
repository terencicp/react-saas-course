...
sequenceDiagram
    ...
    Note over Handler: authedRoute + quota gate pass (Text generation and the route seam)
    ...
    Note over Handler: handler writes the audit event after the await (Text generation and the route seam)
