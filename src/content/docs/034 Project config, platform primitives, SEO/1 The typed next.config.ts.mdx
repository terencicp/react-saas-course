...
<Aside type="caution">
After any edit to `next.config.ts`, restart the dev server. Make "I changed the config and nothing happened, did I restart?" the very first thing you check. It's the most common false alarm with this file, and a five-second fix rather than a config bug.
</Aside>
