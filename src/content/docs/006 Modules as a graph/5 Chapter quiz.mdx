---
title: Quiz - Modules as a graph
description: Check your grasp of import-export shapes, graph evaluation, top-level await vs. lazy init, and augmenting third-party modules.
tagline: A self-check on the ES module system in TypeScript — how imports, exports, and the module graph shape what your app loads and ships.
chapter-id: 006
