...
<VideoCallout videoId="5YLpjPmsPCA" videoTitle="What is the Transactional Outbox Pattern? | Confluent">
  Confluent's 5-minute explainer of the durable outbox your in-memory array upgrades into — the dual-write problem, the table written in the same transaction, a worker draining it at-least-once, and the dedup log that catches the duplicates.
</VideoCallout>
