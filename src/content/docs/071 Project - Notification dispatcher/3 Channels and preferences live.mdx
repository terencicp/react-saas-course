...
The React Email templates themselves ship complete in `src/emails/`; authoring that JSX belongs to [JSX for the email DOM](/049-authoring-email-templates/1-email-templates-with-react-email/), not here.
