...
The full finding follows the same template as the others — read it in `findings/010-composite-index.md` in the solution tree. For indexes and reading query plans, see [Indexes and N+1 in production](/094-performance-vigilance/7-indexes-and-n1-in-production/).
