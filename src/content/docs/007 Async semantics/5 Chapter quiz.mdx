---
title: Quiz - Async semantics
description: Check your grasp of the event loop, Promise combinators, async/await dependency analysis, and cancellation with AbortSignal.
tagline: The chapter quiz on JavaScript's asynchronous model — the event loop, Promises, async/await, and cancellation with AbortController.
chapter-id: 007
