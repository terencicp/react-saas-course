...
tagline: A self-check on the chapter's browser networking material — fetch, FormData and abort signals through to streaming responses and the choice between polling, Server-Sent Events, and WebSockets.
chapter-id: 015
