...
tagline: A graded check on the chapter that closes the JavaScript and TypeScript unit, covering safe JSON parsing, when to reach for a class, and the move from Date to the Temporal API.
chapter-id: 009
