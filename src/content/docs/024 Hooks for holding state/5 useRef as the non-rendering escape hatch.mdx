...
What those four have in common is that they're all <Term definition="Telling the element to do something — focus, play, scroll — rather than describing what it should be.">imperative</Term> operations: you tell the element to do something. That distinction draws the line for the second beginner mistake.
