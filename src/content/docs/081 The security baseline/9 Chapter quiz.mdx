---
title: Quiz - The security baseline
description: Test your grasp of CSP, rate limiting, audit logs, retention, consent, secrets, env validation, and supply-chain defaults.
chapter-id: 081
sidebar:
  order: 9
  label: Chapter quiz
course-progress: 0.7592
---
...
<Quiz sources={{
  ...
  '81.7': 'The env schema',
  '81.8': 'Supply-chain hardening',
}}>
  <MultipleChoice src="81.1">
