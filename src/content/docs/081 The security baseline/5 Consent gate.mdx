...
<StateMachineWalker kind="machine" title="Walk the consent machine — watch the flags and which SDKs are live">
  <Figure slot="diagram" caption="Two independent flags, four states. Every Withdraw edge returns to unset and re-shows the banner: the revocation cycle most banners forget.">
