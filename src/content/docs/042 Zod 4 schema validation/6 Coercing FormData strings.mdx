...
You have a `raw` object full of strings, and the schema wants numbers and dates. The tool is `z.coerce`, the form-input shortcut [Checks and transforms](/042-zod-4-schema-validation/3-checks-and-transforms/) flagged for this very moment, built on the transform machinery that lesson taught.
