...
<VideoCallout videoId="eMotoFvgdUo" videoTitle="Optimistic Locking - What, When, Why, and How?">
  Arpit Bhayani builds optimistic locking from compare-and-swap up to the version-checked write this `WHERE status = 'pending'` precondition is an instance of — what it is, when to use it, and why it beats locking (16 min).
</VideoCallout>
