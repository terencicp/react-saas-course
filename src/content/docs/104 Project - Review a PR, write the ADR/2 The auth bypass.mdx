...
For the four-part comment anatomy, the five severity labels, and the address-the-code-not-the-author reflex, the [comment lesson in chapter 103](/103-reviewing-pull-requests/2-the-comment-that-lands/) owns them — this lesson applies them rather than re-deriving them.
