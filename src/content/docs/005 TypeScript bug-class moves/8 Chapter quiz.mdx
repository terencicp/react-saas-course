...
tagline: A quiz on the TypeScript type-design moves that close off whole classes of bugs, capping the type-system chapter of the JavaScript and TypeScript unit.
chapter-id: 005
