...
<VideoCallout videoId="Bxf_HMs7SeQ" videoTitle="Just store UTC? Handling Time Zones & Daylight Saving">
  Derek Comartin (CodeOpinion) walks the same decision in 8 minutes: why "just store UTC" holds for the past but breaks for future fires, and why you keep the IANA zone name instead.
</VideoCallout>
