...
<VideoCallout videoId="qmpUfWN7hh4" videoTitle="HTTP Status Codes Explained In 5 Minutes">
  ByteByteGo's 5-minute tour of the status families — note how it frames 401 ("no key") versus 403 ("known, but not allowed"), the exact split this section turns on.
</VideoCallout>
