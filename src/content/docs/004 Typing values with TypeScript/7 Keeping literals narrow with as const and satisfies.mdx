...
The pattern across all three is the same: where the value can change, the type widens to admit the values it might change to. <Term definition="Inferred literal broadened to base primitive in reassignable positions.">Widening</Term> is the compiler staying honest about what the value might become.
