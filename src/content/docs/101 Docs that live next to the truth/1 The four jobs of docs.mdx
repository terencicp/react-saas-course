...
<VideoCallout videoId="0BqucaRwHhA" videoTitle="Better Docs with Diátaxis">
  The Scaling DevTools podcast walks the four types against real dev-tool product docs and untangles the common tutorial-versus-how-to confusion. Roughly 24 minutes.
</VideoCallout>
...
:::tip
Don't read the four types as four folders. Read them as four questions you ask about a doc you're already writing: who is reading this, and what did they come to do? The answer tells you which existing file it belongs in.
:::
