---
title: Quiz - Roles, action wrappers, and the audit trail
description: Check your grasp of per-membership roles, the authedAction and authedRoute wrappers, member-management writes, and the append-only audit log.
chapter-id: 057
sidebar:
  order: 7
  label: Chapter quiz
course-progress: 0.5612
---
