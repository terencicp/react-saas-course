...
<VideoCallout videoId="h3IA_Iax-dk" videoTitle="Next.js i18n: App Router + next-intl Tutorial">
  A 10-minute Frontend Basics walkthrough that wires the same spine you're building — the request config's dynamic catalog import, middleware negotiation, a cookie-backed locale switcher, and the `setRequestLocale` + `generateStaticParams` static-rendering trap this mission flags.
</VideoCallout>
