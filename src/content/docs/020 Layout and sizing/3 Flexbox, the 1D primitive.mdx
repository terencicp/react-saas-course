...
:::caution
`flex-row-reverse` reverses what you see, not the source order that the keyboard and screen readers follow. Reordering for visual reasons while leaving focus order untouched is a real accessibility defect, not a cosmetic one.
:::
