...
Read this shape left to right, from the read path through to the two write paths. None of the rationale lives here — *why* `cacheComponents`, *why* these `cacheLife` profiles, *which* invalidation call to reach for — was the subject of *Caching strategy and invalidation*; this project is where you build it.
