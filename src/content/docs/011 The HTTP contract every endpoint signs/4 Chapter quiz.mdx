...
description: Check your grip on methods, status codes, and headers as the contract every endpoint signs.
tagline: The end-of-chapter quiz on HTTP semantics, where you test your grip on the methods, status codes, and headers that every endpoint commits to.
chapter-id: 011
