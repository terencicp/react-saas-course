...
<CodeVariants>
  ...
  <CodeVariant label="z.looseObject">
    ...
    **Preserves unknown keys, for the edge of an integration whose payload you don't fully control.** Use it when a vendor's response carries fields their docs don't list and you want to forward the extras downstream untouched. This is rare.
  </CodeVariant>
</CodeVariants>
