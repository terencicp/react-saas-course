...
The fastest way to make this judgment automatic is to practice it on cases that aren't the wizard. Sort each piece of state below into the tool that owns it.
