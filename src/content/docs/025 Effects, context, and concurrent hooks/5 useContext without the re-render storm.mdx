...
The cohesion rule has one complication, flagged back in ["useReducer when transitions multiply"](/024-hooks-for-holding-state/4-usereducer-when-transitions-multiply/).
