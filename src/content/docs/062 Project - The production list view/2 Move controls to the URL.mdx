...
<VideoCallout videoId="qpczQVJMG1Y" videoTitle="Type-safe URL state in Next.js with nuqs (Vercel, Next.js Conf 2025)">
  The Vercel team's 25-minute Next.js Conf talk walks the same read-on-the-server, write-from-the-client loop you are wiring here — shallow vs. network updates, server parsing, and debounced writes.
</VideoCallout>
