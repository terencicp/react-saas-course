...
<VideoCallout videoId="ihHLs6v7Lko" videoTitle="AI SDK v5: A Crash Course — Matt Pocock at React Universe Conf 2025">
  Matt Pocock's 22-minute v5 crash course walks the same surface you're wiring here — `streamText`, the UI-vs-model-message conversion, system prompts, and the type-safe agentic tool loop.
</VideoCallout>
