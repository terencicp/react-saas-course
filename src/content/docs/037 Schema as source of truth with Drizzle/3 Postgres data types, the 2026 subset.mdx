...
<VideoCallout videoId="oWF5jTFBSHw" videoTitle="Tips for handling timezones in Postgres">
  Aaron Francis (Mastering Postgres) shows in 14 min how `timestamptz` converts to and from UTC on read, and the named-timezone trap that catches you when you reach for raw offsets.
</VideoCallout>
