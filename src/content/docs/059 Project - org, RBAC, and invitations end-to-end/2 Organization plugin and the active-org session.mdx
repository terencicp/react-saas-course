...
<VideoCallout videoId="grvwy4qySVI" videoTitle="OrcDev — Better Auth Organizations: The Basics">
  OrcDev walks the same loop end to end in 25 minutes — registering the org plugin, running the CLI to generate the schema, migrating, the org switcher, and seeding the active org on login.
</VideoCallout>
