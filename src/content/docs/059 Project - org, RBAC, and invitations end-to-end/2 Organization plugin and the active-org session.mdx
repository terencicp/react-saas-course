...
:::note
The role hierarchy and `roleAtLeast` were introduced in [Owner, admin, member](/057-roles-action-wrappers-audit-trail/1-owner-admin-member/). This lesson is where you wire them into the running app.
:::
