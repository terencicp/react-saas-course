...
Rebuild the flow from memory. Drag these six steps into order, from the email request to the user landing with every old session dead.
...
Finally, the watch-outs. Each is a pattern that still ships and that you can catch in a code review:
