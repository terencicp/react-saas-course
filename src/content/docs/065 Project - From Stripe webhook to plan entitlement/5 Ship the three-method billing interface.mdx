...
<VideoCallout videoId="NfeFXQwmDXA" videoTitle="I Mastered Stripe Subscriptions in Next.js 15 and You Can Too!">
  Programming with Umair wires the same three pieces end to end in Next.js 15 server actions — jump to 33:55 for the Checkout session, 44:00 for the Portal, and 48:00 for the webhook, the exact Stripe SDK shape you're building here.
</VideoCallout>
