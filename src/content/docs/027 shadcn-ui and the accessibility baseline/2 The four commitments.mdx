...
- Button types for actions vs. links for navigation: "Buttons, links, and lists" (Chapter 17).
- Label-to-input association with `htmlFor`: "Forms and the FormData contract" (Chapter 17).
- Landmarks and the heading outline: "Landmarks and headings" (Chapter 17).
- The `:focus-visible` ring: "Pseudo-classes and :has()" (Chapter 21).
- The `motion-reduce:` variant: "Motion and animation" (Chapter 21).
- `useId` for stable ARIA wiring: "useId" (Chapter 24).
