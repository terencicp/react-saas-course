...
<VideoCallout videoId="mr_J5v398Qo" videoTitle="Zero-downtime migrations | Postgres.FM 048">
  Postgres experts Nikolay Samokhvalov and Michael Christofides spend 30 minutes on exactly the blind spots this lesson is about — which `ALTER` statements take a blocking lock, why `CREATE INDEX CONCURRENTLY` is the online fix, and how `lock_timeout` keeps a slow migration from freezing the table.
</VideoCallout>
