...
<VideoCallout videoId="KhO4VjaYSXU" videoTitle="Forms with React 19 and Next.js">
  Lee Robinson walks the exact reset-on-commit problem you're solving here — why a `<form action>` blanks its inputs and how `useActionState` echoes the typed values back (9 min).
</VideoCallout>
