...
This is the last lesson of the chapter, and it closes out the documentation half of the unit. [The previous chapter](/101-docs-that-live-next-to-the-truth/1-the-four-jobs-of-docs/) named the four artifacts a repo maintains from the outside: README, AGENTS.md, ADRs, and source-as-reference. This chapter went inside the source file for two more: [TSDoc on the public surface](/102-docs-that-live-in-the-code/1-tsdoc-the-public-surface/) and [`// why` comments](/102-docs-that-live-in-the-code/2-comment-the-why-not-the-what/) on the lines that need one. Every one of those is one merge away from being silently wrong, and this lesson is the discipline that keeps all of them true.
