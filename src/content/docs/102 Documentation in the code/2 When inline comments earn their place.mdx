...
Now sort each comment at speed by whether it earns its place.
...
Sorting is the easy half; writing the right comment under pressure is the half that matters. For each snippet, decide the verdict, and when you keep it, get the voice right.
