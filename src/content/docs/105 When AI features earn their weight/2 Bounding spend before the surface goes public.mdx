...
:::tip
The product rule in one line: show the counter on the second question, not the fifty-first. A visible limit is a feature, and an invisible one is a trap.
:::
