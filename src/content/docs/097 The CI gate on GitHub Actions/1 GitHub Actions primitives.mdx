...
- `on: schedule` fires on a <Term definition="A time-based scheduler. A five-field string sets the cadence: minute, hour, day-of-month, month, day-of-week.">cron</Term> timetable. The next chapter's weekly link-check uses this.
