...
<VideoCallout videoId="eT4JZH6CHHo" videoTitle="How to use GoDaddy with Resend">
  Resend's own 4-minute walkthrough of this exact ceremony on a real registrar — adding the subdomain, copying the DKIM, SPF, and MX values into the DNS panel, and the checklist for when verification stalls.
</VideoCallout>
