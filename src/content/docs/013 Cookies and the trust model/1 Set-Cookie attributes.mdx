...
<VideoCallout videoId="zYp0DFFmGxk" videoTitle="What is CHIPS? — Chrome for Developers">
  Chrome for Developers' 4-minute explainer of the `Partitioned` mechanics — recorded before the 2025 reversal, so treat its "future without third-party cookies" framing as today's reality.
</VideoCallout>
