...
A function's contract is its promise: what you must give it, what it changes, and what it hands back. You'll build the body across the lessons that follow; here you learn the contract, because the contract is the API you call from real code.
