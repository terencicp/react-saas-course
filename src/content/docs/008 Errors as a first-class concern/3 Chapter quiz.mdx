...
tagline: A quiz that tests your command of TypeScript error handling — when to throw versus return a Result, narrowing the catch, and writing domain error classes.
chapter-id: 008
