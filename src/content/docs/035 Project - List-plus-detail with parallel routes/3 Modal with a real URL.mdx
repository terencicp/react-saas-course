...
<VideoCallout videoId="Ft2qs7tOW1k" videoTitle="Next.js Modal with Parallel & Intercepting Routes, shadcn/ui Dialog">
  Dave Gray builds this same intercepting-route modal with a shadcn `Dialog` and a `router.back()` close, including the full-page fallback twin — the exact shape you ship here (26 min).
</VideoCallout>
