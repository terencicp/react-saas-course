...
This works. It opens, it closes, and it shows the photo, and most users will never complain. But there are four things it can't do, all for the same reason: the modal lives in a component's state, and component state is invisible to the URL.
