...
Which props actually cross that wire, and which ones leak a secret you didn't mean to send, is a lesson of its own two ahead. For now you have the geography: server tree, client leaves, and the one rule for nesting them.
